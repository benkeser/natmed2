...
natmed2 <- function(
  ...
  eff <- data.frame(effect = c("E[Y(1,S(1))] / E[Y(0,S(0))]", "E[Y(1,S(0))] / E[Y(0,S(0))]", "E[Y(1,S(1))] / E[Y(1,S(0))]"),
                    ...
                    cil = c(ci_total_eff_cv[1], ci_direct_eff_cv[1], ci_indirect_eff_cv[1]),
                    ciu = c(ci_total_eff_cv[2], ci_direct_eff_cv[2], ci_indirect_eff_cv[2]))
  ...
  eff2 <- data.frame(effect = c("E[Y(1,S(1))] / E[Y(0,S(0))]", "E[Y(1,S(1))] / E[Y(0,S(1))]", "E[Y(0,S(1))] / E[Y(0,S(0))]"),
                    ...
                    cil = c(ci_total_eff_cv[1], ci_direct_eff2_cv[1], ci_indirect_eff2_cv[1]),
                    ciu = c(ci_total_eff_cv[2], ci_direct_eff2_cv[2], ci_indirect_eff2_cv[2]))
